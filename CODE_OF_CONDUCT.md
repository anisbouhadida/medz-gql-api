...
We as members, contributors, and maintainers pledge to make participation in the `medz-gql-api` community a harassment-free experience for everyone, regardless of age, body size, visible or invisible disability, ethnicity, sex characteristics, gender identity and expression, level of experience, education, socio-economic status, nationality, personal appearance, race, religion, or sexual identity and orientation.
...
This Code of Conduct applies within all community spaces for `medz-gql-api`, including:

- GitHub issues
- Pull requests and code review discussions
- Repository discussions, comments, and wiki edits
- Other official maintainer-managed spaces where contributors represent the project
...
Instances of abusive, harassing, or otherwise unacceptable behavior may be reported to the project maintainer at **anisdoescode@outlook.fr** or privately via <https://github.com/anisbouhadida>.
...
If you are reporting a **security vulnerability**, please use the private reporting instructions in [`SECURITY.md`](SECURITY.md) instead of filing a public issue or using this Code of Conduct contact path.
